...
const sqlConnection: knex = knex(knexConfig.tests);

describe('Sql booking repository', () => {

    let sqlBookingRepository: SqlBookingRepository;
    let transactionsPerformer: TransactionPerformer =
    ...
    it('should insert a booking successfully', async () => {
        ...
        await transactionsPerformer.perform(
            trx => sqlBookingRepository.save(new Booking(
        ...
        const bookings = await sqlConnection.select().table('bookings')
            .select()
    ...
    it('should retrieve bookings from a given customer', async () => {
        ...
        const bookings: Booking[] =
            await sqlBookingRepository.byCustomerId('86381977-7922-4943-9336-ca3e0db7eb60');
        expect(bookings).toEqual([new Booking(
            '86381977-7922-4943-9336-ca3e0db7eb60',
            newBookingId,
            startPoint,
            endPoint,
