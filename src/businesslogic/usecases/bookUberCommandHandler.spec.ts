...
describe('Uber booking', () => {
    ...
    describe('Customer willing to enter in Paris', () => {
        ...
        describe('Successful booking', () => {
            ...
            it('should book an uber', async () => {
                ...
                expectBookings(customerId, newBookingId, startPoint, endPoint, availableUberId, 0);
            });
    ...
    describe('Customer willing to leave Paris', () => {
        ...
        describe('Successful booking', () => {
            ...
            it('should book an uber', async () => {
                await bookAnUber(newBookingId, startPoint, endPoint);
                expectBookings(customerId, newBookingId, startPoint, endPoint, availableUberId, 50);
                expect(tripTypeScanner.scanWasCalledWith(startPoint, endPoint)).toBeTruthy();
            });
    ...
    const bookAnUber = (bookingId: string, startPoint: Position, endPoint: Position) => {
